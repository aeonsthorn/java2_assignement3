...
public class Hotel {
  ...
  public Hotel(String name, Room[] rooms) {
    ...
    for (int i = 0; i < rooms.length; i++) this.rooms[i] = rooms[i];
    ...
    for (int i = 0; i < rooms.length; i++) reservations[i] = null;
  ...
  private void removeReservation(String name, String type) {
    ...
    for (int i = 0; i < numOfReservations; i++) {
      ...
      if (
        reservations[i].getName().equalsIgnoreCase(name) &&
  ...
  public String toString() {
    ...
    for (int i = 0; i < rooms.length; i++) {
      ...
      if (rooms[i].getAvailability()) {
        ...
        if (rooms[i].getType().equalsIgnoreCase("double")) d++; else if (
          rooms[i].getType().equalsIgnoreCase("queen")
        ) q++; else if (rooms[i].getType().equalsIgnoreCase("king")) k++;
      }
    }
